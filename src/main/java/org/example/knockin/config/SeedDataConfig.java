...
public class SeedDataConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        File profilePic = File.builder()
                ...
                .savedFileName("profile_saved_123.png")
                .fileExt("png")
                .isDeleted(false)
                .build();
        File boardPic = File.builder()
                ...
                .savedFileName("room_saved_456.jpg")
                .fileExt("jpg")
                .isDeleted(false)
                .build();
        File roomTypePic = File.builder()
                .type(FileType.ETC)
                .originalFileName("oneroom.png")
                .savedFileName("oneroom_saved.png")
                .fileExt("png")
                .isDeleted(false)
                .build();
        File extraOptionPic = File.builder()
                .type(FileType.ETC)
                .originalFileName("option.png")
                .savedFileName("option_saved.png")
                .fileExt("png")
                .isDeleted(false)
                .build();
        File lifePatternPic = File.builder()
                .type(FileType.ETC)
                .originalFileName("life.png")
                .savedFileName("life_saved.png")
                .fileExt("png")
                .isDeleted(false)
                .build();
